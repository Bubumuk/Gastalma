...
public class CalendarioSemanaActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		calendar.init(SelectionMode.SELECTED_WEEK, lastYear.getTime(), maxDate.getTime());
		calendar.selectDate(cDate);
	}

	public void returnFecha(View view) {
		
		List<Date> fechas = calendar.getSelectedDates();
		long start = fechas.get(0).getTime();
		long end = fechas.get(fechas.size()-1).getTime();
