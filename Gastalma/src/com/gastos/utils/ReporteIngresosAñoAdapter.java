...
public class ReporteIngresosAñoAdapter extends ArrayAdapter<Ingreso> implements StickyListHeadersAdapter {
    
    Context context;
    NumberFormat nf;
    
    public ReporteIngresosAñoAdapter(Context context, int resourceId, List<Ingreso> items) {
