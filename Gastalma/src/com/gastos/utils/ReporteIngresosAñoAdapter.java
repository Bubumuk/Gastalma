...
public class ReporteIngresosAñoAdapter extends ArrayAdapter<MesGastos> implements StickyListHeadersAdapter {

	Context context;
	NumberFormat nf;

	public ReporteIngresosAñoAdapter(Context context, int resourceId, List<MesGastos> items) {
